    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center py-2">
            ...
            <div class="ms-3" style="text-align:right">
                ...
                <a class="btn btn-warning" href="{{ route('news.index') }}">ROLL ADMIN</a>
            @endif
        ...
        <main class="row" style="margin-top: 20px;">
            <article class="col-md-9 bg-light">
                @yield('noidung') <!-- Nội dung chính sẽ được chèn vào đây -->
            </article>

            @include('client.view.newest-news', ['tinMoiNhatThem' => $tinMoiNhatThem]) <!-- Bao gồm sidebar -->
        </main>
